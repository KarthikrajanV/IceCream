...
const About = () => {
    return (
        <div id='about'>
            <h1 className='md:text-6xl text-5xl font-robo text-center text-[#a52a2a]'>
                Traditional & Delicious Ice Cream <br /> Since 1950 !
            </h1>
            <div className='container mx-auto md:flex my-10'>
                <div className='md:w-1/3  py-4 px-7 mx-auto' >
                    <div className='pb-8'><span className='font-robo text-4xl text-[#a52a2a] '>About us</span></div>
                ...
                <div className='md:w-1/3  py-4 mx-auto px-7' >
                    <div className='pb-8'><span className='font-robo text-4xl text-[#a52a2a] '>Our Features</span></div>
